...
module.exports = {
  ...
  caption: process.env.CAPTION || "ᵀᴵᴳᴱᴿ 𝗠𝗗 𝗣𝗢𝗪𝗘𝗥 𝗕𝗬 🇱🇰",
  author: process.env.PACK_AUTHER || "ᵀᴵᴳᴱᴿ",
  packname: process.env.PACK_NAME || "♥️",
  botname: process.env.BOT_NAME || "ᵀᴵᴳᴱᴿ 𝐌𝐃",
  ownername: process.env.OWNER_NAME || "ᵀᴵᴳᴱᴿ 𝗧𝗘𝗔𝗠",
